...
class SubtractSquareState(GameState):
    ...
    def rough_outcome(self) -> float:
        ...
        """
        if positive_square(self.current_total):
            return self.WIN
        elif all([positive_square(self.current_total - n ** 2)
...
def positive_square(n: int) -> bool:
    """
    Return whether a positive perfect square.
    """
